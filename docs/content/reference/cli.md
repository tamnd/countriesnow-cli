...
```
countriesnow <command> [arguments] [flags]
```

Run `countriesnow <command> --help` for the full flag list on any command. This
...
per operation you declare in `countriesnow/domain.go`.
