...
Most of these come down to network reality or how countriesnow serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

countriesnow rate-limits like any public site. countriesnow already paces
...
Where a surface is gated, countriesnow reads a cookie or token you supply
...
`countriesnow`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what countriesnow actually did
